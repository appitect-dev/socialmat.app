...
// Cookie options typed to match the third parameter of cookies().set()
// This ensures type safety when setting cookies in setSessionCookie and clearSessionCookie
const cookieOptions = {
  httpOnly: false,
